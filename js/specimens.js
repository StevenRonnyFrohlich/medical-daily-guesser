window.SPECIMENS = [
  ...
  {
    id: "cyto-nilm",
    name: "Normal squamous cells",
    category: "cytology",
    difficulty: 1,
    stain: "Pap",
    mag: "200–400×",
    file: "Pap test normal.jpg",
    files: ["Pap test normal.jpg", "Pap test wnl.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["LSIL (koilocytes)", "Atrophy (small pink cells)", "Squamous metaplasia (immature squamous)"],
    blurb: "Intermediate and superficial squamous cells: abundant cytoplasm, small regular nuclei, a clean background. Superficials are more orangeophilic. This is NILM — negative for intraepithelial lesion or malignancy — until something else in the field argues."
  },
  {
    id: "cyto-endocx",
    name: "Endocervical cells",
    category: "cytology",
    difficulty: 2,
    stain: "Pap",
    mag: "400×",
    file: "Pap test endocervical cells.JPG",
    files: ["Pap test endocervical cells.JPG", "Endocervical cells on Pap test.jpg", "Cytology of endocervical cells.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["Endometrial cells (tight 3-D clusters)", "Squamous metaplasia (immature squamous)", "Adenocarcinoma (glandular cancer)"],
    blurb: "Columnar cells in a honeycomb or a picket-fence strip, pale cytoplasm, regular basal nuclei. They prove you sampled the transformation zone. Endometrial cells are smaller, darker, and more three-dimensional. Atypia and disordered architecture leave benign endocervix."
  },
  {
    id: "cyto-em",
    name: "Endometrial cells",
    category: "cytology",
    difficulty: 3,
    stain: "Pap",
    mag: "400×",
    file: "Endometrial cells on Pap -- high mag.jpg",
    files: ["Endometrial cells on Pap -- high mag.jpg", "Endometrial cells on Pap -- very high mag.jpg", "Endometrial cells on Pap - 2 -- very high mag.jpg"],
    credit: "Wikimedia Commons / Nephron",
    lookalikes: ["Endocervical cells (honeycomb strips)", "HSIL (high-grade squamous lesion)", "Histiocytes (cleanup macrophages)"],
    blurb: "Small cells in tight three-dimensional balls, scant cytoplasm, dark nuclei. Normal in the first half of the cycle in a premenopausal woman; after 45 they earn a comment. Do not call a loose histiocyte cluster an endometrial ball."
  },
  {
    id: "cyto-parabasal",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Parabasal cells - Pap test -- high mag.jpg",
    files: ["Parabasal cells - Pap test -- high mag.jpg", "Parabasal cells - Pap test -- very high mag.jpg", "Parabasal cells - Pap test - 2 -- high mag.jpg"],
    credit: "Wikimedia Commons / Nephron",
    lookalikes: ["HSIL (high-grade squamous lesion)", "Atrophy (small pink cells)", "Squamous metaplasia (immature squamous)"],
    blurb: "Round-oval cells with denser cyanophilic cytoplasm and a higher N/C than intermediate cells, but a smooth nuclear membrane and even chromatin. They belong in atrophy, postpartum, and a deep scrape. HSIL has irregular nuclei and coarse chromatin."
  },
  {
    id: "cyto-atrophy",
    name: "Atrophy",
    ...
    stain: "Pap",
    mag: "200–400×",
    file: "Pap test atropy.JPG",
    files: ["Pap test atropy.JPG"],
    credit: "Wikimedia Commons",
    lookalikes: ["HSIL (high-grade squamous lesion)", "Parabasal cells (deep squamous)", "LSIL (koilocytes)"],
    blurb: "A field of parabasal-type cells, often with a dirty or granular background and naked nuclei. Postmenopausal or postpartum. The trap is overcalling the high N/C as HSIL — look for a smooth nuclear contour and a uniform population, not a few ugly outliers."
  },
  {
    id: "cyto-metaplasia",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Squamous metaplasia - Pap test -- high mag.jpg",
    files: ["Squamous metaplasia - Pap test -- high mag.jpg", "Squamous metaplasia - Pap test -- very high mag.jpg", "Cytology of squamous metaplasia.jpg"],
    credit: "Wikimedia Commons / Nephron",
    lookalikes: ["HSIL (high-grade squamous lesion)", "Endocervical cells (honeycomb strips)", "Parabasal cells (deep squamous)"],
    blurb: "Immature squamous cells from the transformation zone: dense cytoplasm, well-defined cell borders, sometimes a spider-cell look with cytoplasmic processes. Nuclei are round and bland. HSIL shares the N/C but not the smooth chromatin or the tidy borders."
  },
  {
    id: "cyto-lacto",
    name: "Lactobacilli",
    ...
    stain: "Pap",
    mag: "400–1000×",
    file: "Normal vaginal flora on Pap stain.jpg",
    files: ["Normal vaginal flora on Pap stain.jpg", "Normal vaginal flora versus bacterial vaginosis on Pap stain.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["BV (clue cells)", "Leptothrix (long filaments)", "Cytolysis (lactobacillus melt)"],
    blurb: "Rod-shaped Döderlein bacilli on and around healthy intermediate cells. This is the normal vaginal flora that keeps the pH low. Clue cells are coated in coccobacilli, not rods. Long thin filaments are Leptothrix, not these short rods."
  },
  {
    id: "cyto-cytolysis",
    name: "Cytolysis",
    ...
    stain: "Pap",
    mag: "200–400×",
    file: "Pap test citolysis.JPG",
    files: ["Pap test citolysis.JPG"],
    credit: "Wikimedia Commons",
    lookalikes: ["BV (clue cells)", "Candidiasis (yeast on a Pap)", "Atrophy (small pink cells)"],
    blurb: "Lactobacilli have dissolved the cytoplasm of intermediate cells, leaving bare nuclei and a lot of rods. Common in the luteal phase. It is not a pathogen and not BV — the remaining cells are not plastered with coccobacilli."
  },
  {
    id: "cyto-lsil",
    name: "LSIL",
    ...
    files: ["Low grade squamous intraepithelial lesion.jpg", "CIN 1-HPV on ThinPrep.jpg", "Low-Grade SIL with HPV Effect.jpg", "ThinPrep Pap smear HPV.jpeg"],
    credit: "Wikimedia Commons",
    lookalikes: ["HSIL (high-grade squamous lesion)", "Glycogen halo (not a koilocyte)", "Candidiasis (yeast on a Pap)"],
    blurb: "Koilocytes: enlarged, often binucleate nuclei with a sharp perinuclear cavity and a rim of dense cytoplasm. Nuclear enlargement and irregularity make it a lesion, not just glycogen. The cell is still mature — abundant cytoplasm — that is how you stay at LSIL and do not climb to HSIL."
  },
  {
    id: "cyto-hsil",
    name: "HSIL",
    ...
    stain: "Pap",
    mag: "400×",
    file: "High-grade squamous intraepithelial lesion.jpg",
    files: ["High-grade squamous intraepithelial lesion.jpg", "High-Grade SIL.jpg", "High-Grade SIL, ThinPrep (4306966632).jpg", "High-grade squamous intraepithelial lesion - 2 -- high mag.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["LSIL (koilocytes)", "Squamous metaplasia (immature squamous)", "SCC (invasive squamous cancer)"],
    blurb: "Immature squamous cells with a high N/C ratio, irregular nuclear membranes, and coarse chromatin — often in a dark group that jumps out at scanning power. Cytoplasm is scant. Metaplasia is the bland twin. Invasive carcinoma usually adds a tumor diathesis and more pleomorphism."
  },
  {
    id: "cyto-scc",
    ...
    files: ["Cytopathology of nonkeratinizing squamous cell carcinoma.png"],
    credit: "Wikimedia Commons",
    lookalikes: ["HSIL (high-grade squamous lesion)", "Repair (reactive sheets)", "Adenocarcinoma (glandular cancer)"],
    blurb: "Frankly malignant squamous cells, often with a dirty tumor diathesis (blood and necrotic debris). Keratinizing forms make tadpoles and fiber cells; nonkeratinizing forms look like a louder HSIL. One ugly cell is not enough — look for a population plus the background."
  },
  {
    id: "cyto-adeno",
    name: "Adenocarcinoma",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Adenocarcinoma on pap test 1.jpg",
    files: ["Adenocarcinoma on pap test 1.jpg", "Adenocarcinoma on pap test 2.jpg", "Adenocarcinoma - Pap test -- high mag.jpg"],
    credit: "Wikimedia Commons / Nephron",
    lookalikes: ["Endocervical cells (honeycomb strips)", "Endometrial cells (tight 3-D clusters)", "HSIL (high-grade squamous lesion)"],
    blurb: "Glandular cells with nuclear enlargement, nucleoli, and disordered architecture — feathering, rosettes, or crowded strips that have lost the honeycomb. Endocervical AIS is the in-situ cousin. A normal honeycomb sheet does not have this nuclear chaos."
  },
  {
    id: "cyto-candida",
    name: "Candidiasis",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Candida - Pap test -- high mag.jpg",
    files: ["Candida - Pap test -- high mag.jpg", "Candida - Pap test -- very high mag.jpg"],
    credit: "Wikimedia Commons / Nephron",
    lookalikes: ["Leptothrix (long filaments)", "Pollen (not an organism)", "Mucus strands (not a fungus)"],
    blurb: "Pseudohyphae and budding yeasts, often spearing squamous cells ('shish kebab'). Pale pink-to-gray on Pap. Leptothrix is longer, thinner, and segmented without true buds. Report it; it explains the itch, not a SIL."
  },
  {
    id: "cyto-trich",
    name: "Trichomoniasis",
    ...
    files: ["Pap test trichomonas.JPG", "Trichomonas pap test.jpg", "Trichomonas - Pap - 2 -- high mag.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["BV (clue cells)", "Pollen (not an organism)", "Sperm (male gamete)"],
    blurb: "Pear-shaped grey-green organisms, a little larger than a neutrophil nucleus, with an eccentric nucleus. Flagella are a gift when you see them. The background is often dirty and the squamous nuclei a bit reactive. Do not call every blob a trich — look for the nucleus."
  },
  {
    id: "cyto-bv",
    name: "BV",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Clue cells - Pap test -- very high mag.jpg",
    files: ["Clue cells - Pap test -- very high mag.jpg", "Clue cells - Pap test -- high mag.jpg", "Clue cells - CDC PHIL 3720.jpg"],
    credit: "Wikimedia Commons / CDC",
    lookalikes: ["Lactobacilli (normal vaginal rods)", "Cytolysis (lactobacillus melt)", "Candidiasis (yeast on a Pap)"],
    blurb: "Clue cells: squamous cells so coated in coccobacilli that the cell border blurs. Lactobacilli are gone or scarce. This is bacterial vaginosis, a shift in flora, not a single named pathogen on the slide. Neutrophils are usually few — it is not a florid vaginitis picture."
  },
  {
    id: "cyto-actinomyces",
    name: "Actinomyces",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Actinomyces on Pap test.jpg",
    files: ["Actinomyces on Pap test.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["Candidiasis (yeast on a Pap)", "Mucus tangle (not Actinomyces)", "Leptothrix (long filaments)"],
    blurb: "Cotton-ball or dust-bunny colonies of filamentous bacteria, often with a clubbed edge. Classic in IUD users. Most are colonizers, not pelvic actinomycosis — the call is 'organisms consistent with Actinomyces.' Mucus and Candida are the usual overcalls."
  },
  {
    id: "cyto-hsv",
    name: "Herpes",
    ...
    files: ["Herpes simplex cytopathy.jpg", "Herpes simplex virus pap test.jpg", "Herpes simplex virus pap test 2.jpg", "Herpes infection on ThinPrep Pap smear (4131420362).jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["Repair (reactive sheets)", "Multinucleated endocervical cells (benign)", "SCC (invasive squamous cancer)"],
    blurb: "The 3 Ms: multinucleation, molding, and margination of chromatin. Nuclei look ground-glass. This is a call you can make on morphology and one the clinician needs the same day. Repair is a flat sheet with nucleoli and no molding."
  },
  {
    id: "cyto-leptothrix",
    name: "Leptothrix",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Leptothrix - PAP smear (52141194493).jpg",
    files: ["Leptothrix - PAP smear (52141194493).jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["Candidiasis (yeast on a Pap)", "Lactobacilli (normal vaginal rods)", "Actinomyces (cotton-ball filaments)"],
    blurb: "Very long, thin, segmented filaments — a hair across the field. Often keeps company with Trichomonas. Not Candida (no yeasts, no shish-kebab) and not Actinomyces (no cotton ball). It is flora, not a disease by itself."
  },
  {
    id: "cyto-cornflake",
    name: "Cornflake artifact",
    category: "cytology",
    difficulty: 2,
    stain: "Pap",
    mag: "400×",
    file: "Cervical squamous cells with cornflake artifact.jpg",
    files: ["Cervical squamous cells with cornflake artifact.jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["Candidiasis (yeast on a Pap)", "Keratin debris (anucleate squames)", "Contaminant (not a cell)"],
    blurb: "Brown, crunchy-looking air-drying of the coverslip on superficial cells — a cornflake on the cytoplasm. It is a prep artifact, not pigment and not fungus. Refocus; the cell underneath is usually fine. Do not call it a koilocyte or a contaminant organism."
  },
  {
    id: "cyto-pollen",
    name: "Pollen",
    ...
    stain: "Pap",
    mag: "400×",
    file: "Pollen grain in a Pap smear (50680466927).jpg",
    files: ["Pollen grain in a Pap smear (50680466927).jpg"],
    credit: "Wikimedia Commons",
    lookalikes: ["Trichomoniasis (flagellate on a Pap)", "LSIL (koilocytes)", "Starch granule (glove powder)"],
    blurb: "A geometric, often yellow-brown grain with a thick wall and no nucleus. It blew in, or rode in on a speculum. Trichomonas has a nucleus and a softer contour. Starch is Maltese-cross under polarized light and usually smaller."
  }
];
...
(function assignTracks(list) {
  ...
  list.forEach((item) => {
    ...
    else if (item.category === "cytology") item.track = "cytology";
